...
class EL_Admin_New {
	...
	public function edit_event() {
		...
		$out .= '
					...
					<tr>
						<th><label>Presenter</label></th>
						<td><input type="text" class="text" name="presenter" id="presenter" value="'.str_replace('"', '&quot;', isset($event->presenter) ? $event->presenter : '').'" /></td>
					</tr>
					<tr>
						<th><label>Affiliate (required)</label></th>
						<td><input type="text" class="text" name="affiliate" id="affiliate" value="'.str_replace('"', '&quot;', isset($event->affiliate) ? $event->affiliate : '').'" /></td>
					</tr>
					<tr>
						<th><label>Affiliate URL (required)</label></th>
						<td><input type="text" class="text" name="affiliateURL" id="affiliateURL" value="'.str_replace('"', '&quot;', isset($event->affiliateURL) ? $event->affiliateURL : '').'" /></td>
					</tr>
					<tr>
