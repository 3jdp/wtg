...
class EL_Db {
	...
	public function update_event($event_data) {
		...
		//presenter
		if( !isset( $event_data['presenter'] ) || $event_data['presenter'] === '' ) { return false; }
		$sqldata['presenter'] = stripslashes( $event_data['presenter'] );
		//affiliate
		if( !isset( $event_data['affiliate'] ) || $event_data['affiliate'] === '' ) { return false; }
		$sqldata['affiliate'] = stripslashes( $event_data['affiliate'] );
		//affiliateURL
		if( !isset( $event_data['affiliateURL'] ) || $event_data['affiliateURL'] === '' ) { return false; }
		$sqldata['affiliateURL'] = stripslashes( $event_data['affiliateURL'] );
		//location
